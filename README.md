...
## Token
In order to use the SDK in production a *token* is required. This token is a `base64` string containing *challenges* and *transaction id*. The token can be generated by calling the Datachecker Token API. 
